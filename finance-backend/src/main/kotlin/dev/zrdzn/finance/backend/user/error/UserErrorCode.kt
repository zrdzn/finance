...
enum class UserErrorCode(val status: Int, val code: String, val description: String) {
    ...
    USERNAME_LENGTH_INVALID(HttpStatus.BAD_REQUEST.value(), "USER_USERNAME_LENGTH_INVALID", "Username must be between $MIN_USERNAME_LENGTH and $MAX_USERNAME_LENGTH characters long"),
    PASSWORD_LENGTH_INVALID(HttpStatus.BAD_REQUEST.value(), "USER_PASSWORD_LENGTH_INVALID", "Password must be between $MIN_PASSWORD_LENGTH and $MAX_PASSWORD_LENGTH characters long"),
