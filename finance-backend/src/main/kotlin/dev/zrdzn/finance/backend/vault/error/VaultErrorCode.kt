...
enum class VaultErrorCode(val status: Int, val code: String, val description: String) {
    ...
    NAME_LENGTH_INVALID(HttpStatus.BAD_REQUEST.value(), "VAULT_NAME_LENGTH_INVALID", "Vault name must be between $MIN_NAME_LENGTH and $MAX_NAME_LENGTH characters long"),
